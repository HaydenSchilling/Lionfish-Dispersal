...
Points = pd.read_csv("/srv/scratch/z3374139/Lionfish/Forward/From 2019/Shallow_end_points_reduced.csv")
...
npart3 = 2
# Number of repeated releases - this is now taken from our run time function by runtime.days
repeats3 = 121 # results of # datetime(2013,5,1) - datetime(2013,1,1)
# Random lat/lon within each Ocean Zone
# List of random points

# Particle release times.
pset_start3 = (datetime(2020,1,1) - datetime.strptime(str(fieldset.time_origin)[0:10], "%Y-%m-%d")).total_seconds()  # Start time (in seconds since fieldset start).
...
out_file3 = "/srv/scratch/z3374139/Lionfish/Forward/From 2020/2020_before_main_spawning_" + str(array_ref) +".nc"
