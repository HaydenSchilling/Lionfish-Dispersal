...
filenames = {'U': sorted((glob('/srv/scratch/z3374139/Lionfish/Sea_Data/Med_29m_2019*'))), 
             'V': sorted((glob('/srv/scratch/z3374139/Lionfish/Sea_Data/Med_29m_2019*'))),
...
Points = pd.read_csv("/srv/scratch/z3374139/Lionfish/observations.csv")
lon_array = Points['X'].to_list()
lat_array = Points['Y'].to_list()
...
# pset_start = (datetime(2013,5,1) - datetime.strptime(str(fieldset.time_origin)[0:10], "%Y-%m-%d")).total_seconds()  # Start time (in seconds since fieldset start).
...
# out_file = "/srv/scratch/z3374139/Lionfish/2013/2013_Main_Spawning_" + str(array_ref) +".nc"
...
# Particle release times.
pset_start3 = (datetime(2019,1,1) - datetime.strptime(str(fieldset.time_origin)[0:10], "%Y-%m-%d")).total_seconds()  # Start time (in seconds since fieldset start).
...
out_file3 = "/srv/scratch/z3374139/Lionfish/Forward/From 2019/2019_before_main_spawning_" + str(array_ref) +".nc"
