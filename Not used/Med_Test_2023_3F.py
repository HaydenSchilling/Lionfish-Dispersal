...
Points = pd.read_csv("/srv/scratch/z3374139/Lionfish/Forward/From 2022/Shallow_end_points_reduced.csv")
...
out_file3 = "/srv/scratch/z3374139/Lionfish/Forward/From 2023/2023_before_main_spawning_" + str(array_ref) +".nc"
