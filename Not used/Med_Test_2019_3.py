...
Points = pd.read_csv("/srv/scratch/z3374139/Lionfish/2018/Shallow_end_points_reduced.csv")
...
out_file3 = "/srv/scratch/z3374139/Lionfish/2019/2019_before_main_spawning_" + str(array_ref) +".nc"
