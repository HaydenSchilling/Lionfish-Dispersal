...
#Points = pd.read_csv("C:/Users/htsch/Documents/GitHub/Lionfish-Dispersal/observations.csv")
...
pset_start = (datetime(2019,5,1) - datetime.strptime(str(fieldset.time_origin)[0:10], "%Y-%m-%d")).total_seconds()  # Start time (in seconds since fieldset start).
...
out_file = "/srv/scratch/z3374139/Lionfish/Forward/From 2019/2019_Main_Spawning_" + str(array_ref) +".nc"
