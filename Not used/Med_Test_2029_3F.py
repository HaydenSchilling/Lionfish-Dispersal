...
Points = pd.read_csv("/srv/scratch/z3374139/Lionfish/Forward/From 2028/Shallow_end_points_reduced.csv")
...
out_file3 = "/srv/scratch/z3374139/Lionfish/Forward/From 2029/2029_before_main_spawning_" + str(array_ref) +".nc"
