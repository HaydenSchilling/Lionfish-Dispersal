...
# Particle release times.
pset_start2 = (datetime(2020,8,1) - datetime.strptime(str(fieldset.time_origin)[0:10], "%Y-%m-%d")).total_seconds()  # Start time (in seconds since fieldset start).
...
out_file2 = "/srv/scratch/z3374139/Lionfish/Forward/From 2022/2022_after_main_spawning_" + str(array_ref) +".nc"
