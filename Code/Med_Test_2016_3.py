...
Points = pd.read_csv("/srv/scratch/z3374139/Lionfish/2015/Shallow_end_points_reduced.csv")
...
# Particle release times.
pset_start3 = (datetime(2016,1,1) - datetime.strptime(str(fieldset.time_origin)[0:10], "%Y-%m-%d")).total_seconds()  # Start time (in seconds since fieldset start).
...
out_file3 = "/srv/scratch/z3374139/Lionfish/2016/2016_before_main_spawning_" + str(array_ref) +".nc"
