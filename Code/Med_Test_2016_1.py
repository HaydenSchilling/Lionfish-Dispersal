...
pset_start = (datetime(2016,5,1) - datetime.strptime(str(fieldset.time_origin)[0:10], "%Y-%m-%d")).total_seconds()  # Start time (in seconds since fieldset start).
...
out_file = "/srv/scratch/z3374139/Lionfish/2016/2016_Main_Spawning_" + str(array_ref) +".nc"
