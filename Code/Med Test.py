...
filenames = {'U': (glob('/Users/htsch/Documents/GitHub/Lionfish-Dispersal/Data/Med_29m_201*')), 
             'V': (glob('/Users/htsch/Documents/GitHub/Lionfish-Dispersal/Data/Med_29m_201*')),
             'bathy': '/Users/htsch/Documents/GitHub/Lionfish-Dispersal/Data/Bathymetry/MED-MFC_006_013_mask_bathy.nc'}#,
             #'bathy': (glob('/Users/htsch/Documents/GitHub/Lionfish-Dispersal/Data/Temp_*'))}
...
lon_array = [35.7]#, 153.7313, 153.7861, 148.9148, 150.1600, 150.3833, 153.0958, 153.3182, 153.8036, 153.6422]
lat_array = [34.490556]#, -29.4, -28.1, -38, -37, -35.7, -31.4, -30.4, -28.8, -27.3]
...
pset_start = (datetime(2012,5,1) - datetime.strptime(str(fieldset.time_origin)[0:10], "%Y-%m-%d")).total_seconds()  # Start time (in seconds since fieldset start).
...
lon = np.repeat(lon_array,repeats*npart)
lat = np.repeat(lat_array,repeats*npart)
...
out_file = "/Users/htsch/Documents/GitHub/Lionfish-Dispersal/Output/2012_Med_Test_output1.nc"
...
kernels = pset.Kernel(AdvectionRK4) +  SampleAge +  SampleDistance + DiffusionUniformKh +SampleBathy #+ SampleTemp#SampleBathy  + 
...
pset.execute(kernels, 
             ...
             endtime=datetime(2012,5,1)+delta(days=91)+delta(days=26),
...
plotTrajectoriesFile("/Users/htsch/Documents/GitHub/Lionfish-Dispersal/Output/2012_Med_Test_output1.nc")
...
# Particle release times.
pset_start2 = (datetime(2012,8,1) - datetime.strptime(str(fieldset.time_origin)[0:10], "%Y-%m-%d")).total_seconds()  # Start time (in seconds since fieldset start).
...
lon2 = np.repeat(lon_array,repeats2*npart2)
lat2 = np.repeat(lat_array,repeats2*npart2)
...
out_file2 = "/Users/htsch/Documents/GitHub/Lionfish-Dispersal/Output/2012_Med_Test_output2.nc"
...
plotTrajectoriesFile("/Users/htsch/Documents/GitHub/Lionfish-Dispersal/Output/2012_Med_Test_output2.nc")
...
# Particle release times.
pset_start3 = (datetime(2012,1,1) - datetime.strptime(str(fieldset.time_origin)[0:10], "%Y-%m-%d")).total_seconds()  # Start time (in seconds since fieldset start).
...
lon3 = np.repeat(lon_array,repeats3*npart3)
lat3 = np.repeat(lat_array,repeats3*npart3)
...
out_file3 = "/Users/htsch/Documents/GitHub/Lionfish-Dispersal/Output/2012_Med_Test_output3.nc"
